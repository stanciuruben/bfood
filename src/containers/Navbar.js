...
import { setCartVisibility, setUserInfoVisibility } from '../redux/actions';

const Navbar = ({ isCartVisible, isUserInfoVisible, setCartVisibility, setUserInfoVisibility }) => {
    const handleUserInfoToggler = () => {
        setCartVisibility( false );
        if ( isUserInfoVisible ) { 
            setUserInfoVisibility( isCartVisible ); 
            return; 
        }
    ...
    return (
        <nav id='main-nav'>
            ...
            <div className='container'>
                <SearchBar />
                <button onClick={ () => setCartVisibility( true ) } className="main-nav-button" title="Cart" >
                    <svg preserveAspectRatio="xMaxYMin meet" viewBox="0 0 512 512" fill="#D2E0DD">
                        <path d="M199.039 373.884A46.058 46.058 0 10245.1 419.941 46.111 46.111 0 00199.039 373.884zM380.316 373.884a46.058 46.058 0 1046.059 46.057A46.111 46.111 0 00380.316 373.884zM455.132 127.679H141.567l-6.8-40.047A49.869 49.869 0 0085.475 46H56.868a10 10 0 100 20H85.474A29.92 29.92 0 01115.05 90.979l36.21 213.315a49.871 49.871 0 0049.3 41.632H413.729a10 10 0 000-20H200.556a29.92 29.92 0 01-29.576-24.979L167.34 279.5H376.362a59.816 59.816 0 0057.131-41.666l31.161-97.1a10 10 0 00-9.522-13.055z"></path>
                    </svg>
                </button>
                <button onClick={ handleUserInfoToggler } className="main-nav-button" title="User Info" >
                    <svg preserveAspectRatio="xMaxYMin meet" fill="#D2E0DD" viewBox="0 0 30 30">
...
const mapDispatchToProps = dispatch => ( { 
    ...
    setUserInfoVisibility: isVisible => dispatch( setUserInfoVisibility( isVisible ) ),
} );
