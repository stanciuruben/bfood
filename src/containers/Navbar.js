...
import { setCartVisibility } from '../redux/actions';

const Navbar = ({ setCartVisibility }) => {
    ...
    return (
        <nav id='main-nav'>
            ...
            <div className='container'>
                ...
                <button onClick={ () => setCartVisibility( false ) } className="main-nav-button" title="User Info" >
...
const mapDispatchToProps = dispatch => ( { setCartVisibility: isVisible => dispatch( setCartVisibility( isVisible ) ) } )
